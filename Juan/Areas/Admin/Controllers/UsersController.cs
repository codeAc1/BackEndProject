...
namespace Juan.Areas.Admin.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> ProfilUpdate(UserVM user, bool? status, int page = 1)
        {
            ...
            {
                ModelState.AddModelError("Name", "UserName Alreade Exist");
            ...
            if (user.ImageFile != null)
            {
                ...
                appUser.Image = user.ImageFile.CreateFile(_env, "user", "assets", "img", "usersImage");
            }
